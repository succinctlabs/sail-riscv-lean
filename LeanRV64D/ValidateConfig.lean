...
/-- Type quantifiers: k_ex1290092_ : Bool -/
    ...
    (do
      ...
      let pmas_ok ← do
        (pure (check_pma_regions (← readReg pma_regions) (zeros (n := 64)) (zeros (n := 64))
            check_opts false))
      -- SP1: mirrors `plat_have_clint` (the generator inlines this literal separately).
      ...
      -- SP1: mirrors `plat_have_sig` (the generator inlines this literal separately).
...
/-- Type quantifiers: k_ex1290093_ : Bool -/
